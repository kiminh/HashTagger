...
//		}
		...
		while(itNA.hasNext()){
			...
			System.out.println("Start of newsgetStatusWithWord article: " + na.getId());
			try{
			...
			List<HashtagEntity> hashtags = findHashtagsFromCombination2(hashtagFinder, hashtags1,keyPhrases);
